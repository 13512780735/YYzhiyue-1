...
import mabeijianxi.camera.util.AndroidWorkaround;
...
public class MediaRecorderActivity extends Activity implements
     ...
     * 录制最小时间
     */
    private static int RECORD_TIME_MIN = (int) (10 * 1000);
    /**
     * 刷新进度条
     */
...
//        // 透明导航栏
    ...
    private void loadViews() {
        ...
        record_finish = (TextView) findViewById(R.id.record_finish);
        ...
        record_finish.setOnClickListener(this);
        ...
        mRecordController.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mMediaRecorder == null) {
                    ...
                    startRecord();
                    mRecordController.setClickable(false);
                }
            }
        });
    }
...
//		TODO 开始录制的图标
        ...
        if (mMediaObject.getDuration() == RECORD_TIME_MAX) {
            ...
            record_finish.setVisibility(View.VISIBLE);
            //record_finish.performClick();
        }
    }
...
//        }
        ...
        } else if (id == R.id.record_finish) {// 停止录制
    ...
    private int checkStatus() {
        ...
        if (!isFinishing() && mMediaObject != null) {
            ...
            if (duration < RECORD_TIME_MIN) {
                ...
                // 视频必须大于3秒
                if (record_finish.getVisibility() != View.INVISIBLE)
                    record_finish.setVisibility(View.INVISIBLE);
            } else {
                // 下一步
                if (record_finish.getVisibility() != View.VISIBLE) {
                    record_finish.setVisibility(View.VISIBLE);
                }
            }
        }
    ...
    public void onEncodeComplete() {
        ...
        try {
            ...
            path = mMediaObject.getOutputTempTranscodingVideoPath();
