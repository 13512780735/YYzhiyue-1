package com.wbteam.YYzhiyue.citypicker.view;
...
public class SideLetterBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < b.length; i++) {
            ...
            paint.setColor(getResources().getColor(R.color.font_color));
            paint.setAntiAlias(true);
            if (i == choose) {
                paint.setColor(getResources().getColor(R.color.font_color1));
