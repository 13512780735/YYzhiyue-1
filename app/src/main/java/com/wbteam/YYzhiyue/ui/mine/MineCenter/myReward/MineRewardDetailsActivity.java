...
import com.wbteam.YYzhiyue.adapter.reward.RewardDetailsAdapter;
...
public class MineRewardDetailsActivity extends BaseActivity implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mine_reward_details);
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                switch (view.getId()) {
                    case R.id.tv_confirm:
                        RetrofitUtil.getInstance().Confirmattend(ukey, id, rkey, new Subscriber<BaseResponse<EmptyEntity>>() {
                            @Override
    ...
    private void initAdapter() {
        mAdapter = new RewardDetailsAdapter(R.layout.reward_details_listview, data);
