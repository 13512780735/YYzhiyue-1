...
import com.wbteam.YYzhiyue.adapter.neaeby.GroupHeaderAdapter;
 ...
 */
public class MesGroupFragment extends BaseFragment implements OnItemClickListener, SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setContentView(R.layout.fragment_mes_group);
        initView();
    ...
    private void initAdapter() {
        mAdapter = new GroupHeaderAdapter(R.layout.nearby_group_listview_items, data);
