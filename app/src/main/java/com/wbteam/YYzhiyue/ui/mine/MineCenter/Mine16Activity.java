...
import com.wbteam.YYzhiyue.util.CommonUtils;
...
import static com.wbteam.YYzhiyue.util.CommonUtils.SIZE_1;
import static com.wbteam.YYzhiyue.util.CommonUtils.SIZE_2;
import static com.wbteam.YYzhiyue.util.CommonUtils.getScreenWidth;
import static com.wbteam.YYzhiyue.util.CommonUtils.getScreenHeight;

public class Mine16Activity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mine16);
...
//        // 透明导航栏
    ...
    public void onBackPressed() {
        ...
        if ("1".equals(videoKey)) {
            Intent intent01 = new Intent(Mine16Activity.this, ViedeoAuthenticationActivity.class);
            startActivity(intent01);
            finish();
        } else if ("2".equals(videoKey)) {
            Intent intent01 = new Intent(Mine16Activity.this, Mine17Activity.class);
            startActivity(intent01);
            finish();
        } else if ("3".equals(videoKey)) {
            Intent intent01 = new Intent(Mine16Activity.this, Perfect02Activity.class);
            startActivity(intent01);
            finish();
        }
        super.onBackPressed();
    ...
    @OnClick({R.id.video_flash_light, R.id.swicth_camera, R.id.record_button, R.id.tv_upload, R.id.tv_cancel, R.id.back_view})
    ...
    private void doStartSize() {
       ...
       // CommonUtils.setViewSize(cameraShowView, screenWidth * SIZE_1 / SIZE_2, screenHeight - 50);
        CommonUtils.setViewSize(cameraShowView, screenWidth * SIZE_1 / SIZE_2, screenWidth);
    }
    ...
    private void initCamera(int type, boolean flashDo) {
        ...
        try {
            ...
            if (type == 0) {
                ...
                //  parameters.setPreviewSize(getOptimalPreviewSize().width,get);
    ...
    private boolean startRecord() {
        ...
        try {
            ...
            if (rotationRecord == 180) {
                ...
                //正向的前置
                frontRotation = (rotationRecord == 0) ? 250 - frontOri : frontOri; //录制下来的视屏选择角度，此处为前置
            }
    ...
    private void endRecord() {
        ...
        // tvUpload.setVisibility(View.VISIBLE);
        Log.d("TAG", "11111");
        Log.d("TAG11", videoFile.getAbsolutePath());
        uri = videoFile.getAbsolutePath();
        Log.d("TAG222", uri);
