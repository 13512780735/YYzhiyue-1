...
public class PoiKeywordSearchAdapter extends RecyclerView.Adapter<PoiKeywordSearchAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(mContext).inflate(R.layout.circum_city_listview, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.ll_item_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((CircumCityActivity) mContext).setDetailAddress(poiAddressBean.getDetailAddress());
            }
        });
    }
